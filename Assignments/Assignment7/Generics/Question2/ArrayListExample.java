...
// leave this main method as is:
	...
	public static void main(String[] args) {
		 ...
		 * rects = new ArrayList<Rectangle>(); rects.add(new Rectangle(2.0, 3.0));
		 * rects.add(new Rectangle(5.0, 5.0)); // Make a list of spheres
		 * ArrayList<Sphere> spheres = new ArrayList<Sphere>(); spheres.add(new
		 * Sphere(10.0)); spheres.add(new Sphere(50.0)); spheres.add(new Sphere(0.0));
		 * // Super-size them System.out.println();
		 * System.out.println("super-sizing a list of rectangles"); ArrayList<Rectangle>
		 * double_rects = supersize_list(rects); describe_all(double_rects);
		 * System.out.println(); System.out.println("super-sizing a list of spheres");
